...
namespace TodoTxt.Sharp.Tests
{
    ...
    public class TaskTests
    {
        ...
        [Test]
        public void Priority_TaskWithAPriorityIncrerase_IsA()
        {
            var t = new Task("(B) a task");
        ...
        [Test]
        public void Priority_TaskWithAPriorityDecrerase_IsB()
        {
            var t = new Task("(A) a task");

            t.ReducePriority();

            Assert.AreEqual(Priority.B, t.Priority);
            Assert.AreEqual("(B) a task", t.Raw);
        }

        [Test]
        public void Priority_TaskWithoutAPriorityIncrerase_IsA()
        {
            var t = new Task("a task");
        ...
        [Test]
        public void Priority_TaskWithoutAPriorityDecrerase_IsA()
        {
            var t = new Task("a task");
        ...
        public void CompletionDate_SetCompletionDate_CompletionDateIsSetToSpecifiedDateAndCreationDateIntactAndRaw()
        {
            ...
            t.Raw = "x 2013-08-02 2013-08-01 some task";
        ...
        {
            var t = new Task("(A) 2013-02-05 some task");
            t.Raw = "x 2013-08-02 2013-02-05 some task";
